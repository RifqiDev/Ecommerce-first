                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ url('users/' . $id) }}" method="POST" >
                        ...
                        <div class="form-group">
                            <label for="nama">Nama = {{ $rec->name }}</label>
                        </div>
                        <div class="form-group">
                            <label for="role">Role </label>
                            <select name="role" id="role" class="form-control select2" style="width: 20%;">
                                <?php
                                $role = DB::table('role')->get();
                                ?>
                                @foreach ($role as $idrole)
                                    <option value="{{ $idrole->nama }}"
                                        {{ $rec->id == $idrole->nama ? 'selected' : '' }}>
                                        {{ $idrole->nama }}
                                    </option>
                                @endforeach
                            </select>
