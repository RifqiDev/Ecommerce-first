        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <h1>Form Edit  {{ $nama }}</h1>
                        <form action="{{ url('stok/' . $id) }}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                            <input type="text" name="id" id="" value="{{ $id }}">
                            <input type="text" name="fotolama" id="fotolama" value="{{ $rec->foto }}">

                            {{ method_field('PUT') }}
                            <div class="form-group">
                                <label for="kode">Kode</label>
                                <input type="text" class="form-control" id="kode" name="kode" value="{{$rec->kode }}">
                            </div>
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama" value="{{ $rec->nama }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="idsatuan" id="idsatuan" class="form-control select2" style="width: 20%;">
                                    ...
                                    ?>
                                    @foreach ($satuan as $idsatuan)
                                        <option value="{{ $idsatuan->id }}"
                                            {{ $rec->idsatuan == $idsatuan->id ? 'selected' : '' }}>
                                            {{ $idsatuan->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="idkategori" id="idkategori" class="form-control select2" style="width: 20%;">
                                    ...
                                    @foreach ($kategori as $idkategori)
                                        <option value="{{ $idkategori->id }}"
                                            {{ $rec->idkategori == $idkategori->id ? 'selected' : '' }}>
                                            {{ $idkategori->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tglexp" name="tglexp" value="{{ $rec->tglexp }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desc" name="desc" value="{{ $rec->desc}}">
                            </div>
                            <div class="form-group">
                                <label for="pajang">Pajang</label>
                                <input type="number" class="form-control" id="pajang" name="pajang" value="{{ $rec->pajang}}">
                            </div>
