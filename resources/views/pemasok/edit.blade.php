            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ url('prodi/' . $id) }}" method="POST">
                        ...
                        {{ method_field('PUT') }}
                        <br>
                        <label for="falkultas">Id Falkultas</label>
                        <br>
                        <select name="falkultas" id="falkultas" class="form-control select2" style="width: 20%;">
                            <?php
                            $falkultasData = DB::table('tbfalkultas')
                                ->select('*')
                                ->get();
                            ?>
                            @foreach ($falkultasData as $item)
                                <option value="{{ $item->id }}"
                                    {{ $rec->falkultas == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="jenjang" id="jenjang" class="form-control select2" style="width: 20%;">
                            <?php
                            $jenjangList = DB::table('tbjenjang')->get();
                            ?>
                            @foreach ($jenjangList as $jenjang)
                                <option value="{{ $jenjang->id }}"
                                    {{ $rec->jenjang == $jenjang->id ? 'selected' : '' }}>
                                    {{ $jenjang->nama }}
                                </option>
                            @endforeach
                        </select>
