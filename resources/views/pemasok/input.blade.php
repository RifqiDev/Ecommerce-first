  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        Kode
        <br><input type="text" name="kode" value="{{ isset($kode) ? $kode : '' }}">

            <br>
                Nama
        <br><input type="text" name="nama" value="{{ isset($nama) ? $nama : '' }}">
            <br>

            Alamat
            <br><input type="text" name="alamat" value="{{ isset($alamat) ? $alamat : '' }}">
            <br>

            No HP
            <br><input type="number" name="hp" value="{{ isset($hp) ? $hp : '' }}">
                <br>

                Time of Paymet
                <br><input type="date" name="top" value="{{ isset($top) ? $top : '' }}">
                    <br>
                    <br>
